...
#define HOUSE_A "010CE3A45812"  //change this ID with your own card TAG
#define HOUSE_B "010CE0980772"  //change this ID with your own card TAG
#define HOUSE_C "010CE0981D68"  //change this ID with your own card TAG
#define HOUSE_D "010CE3A42D67"  //change this ID with your own card TAG
...
void loop(){
  ...
  if(msg.indexOf(HOUSE_A)>=0)
  {    
    valRFID=1;
    Serial.println("HA");  
     
  }
  else if(msg.indexOf(HOUSE_B)>=0)
  {
    valRFID=2;
    Serial.println("HB");  
     
  } 
  else if(msg.indexOf(HOUSE_C)>=0)
  {
    valRFID=3;
    Serial.println("HC");  
     
  }  
  else if(msg.indexOf(HOUSE_D)>=0)
  {
    valRFID=4;
    Serial.println("HD");  
